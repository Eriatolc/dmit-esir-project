...
/*
 * Constructor of the Sensortag Deamon
 */
function SensortagDeamon(server) {
	var self = this;
	this._server = server;
...
SensortagDeamon.prototype.sendFallAlert = function(x, y ,z, threshold, norme) {
	var self = this;
	var alert = {
		type: 'FallAlert',
		data: {
...
SensortagDeamon.prototype.sendDisconnectAlert = function() {

};

SensortagDeamon.prototype.sendTempAlert = function(temperature) {
	var self = this;
	var alert = {
		type: 'TempAlert',
		data: {
...
SensortagDeamon.prototype.sendKeyAlert = function(left, right) {
	var self = this;
	var alert = {
		type: 'KeyAlert',
		data: {
