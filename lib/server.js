...
//var SensorTagDeamon = require('./sensortagDeamon.js');
...
function Server(config) {
	...
	this._server = server;
	this._config = config;
	//this._sensorTagDemaon = new SensorTagDeamon(this._config);
	...
	// Lancement du SensorTagDeamon
	//this._sensorTagDemaon.start();
