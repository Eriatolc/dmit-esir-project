 ...
 * @contributor Clotaire Delanchy <clo.delanchy@gmail.com>
 * @copyright © Clément Désiles
 * @requires mongoskin
 * @description
 *
...
// DMIT project database
var db = mongo.db(config.domain + '/dmit', { safe: true });
...
/**
 * Return a simple error report from a MongoDB Error.
...
var Database = module.exports = {
	...
	/**
	 * Get the numbers of documents in a collection
	 *
	 * @param collection {String} Mongo collection name
	 * @param search {Object} search criterias
	 * @param filters {Object} filter the searched contents
	 ...
	 * @return none
	 */
	count: function(collection, search, filters, callback) {
		if(!callback) {console.log('no callback: return'); return; }
